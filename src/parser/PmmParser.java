...
public class PmmParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_mantissa = 1;
	...
	public static class MantissaContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof PmmVisitor ) return ((PmmVisitor<? extends T>)visitor).visitMantissa(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final MantissaContext mantissa() throws RecognitionException {
		...
		enterRule(_localctx, 2, RULE_mantissa);
		try {
			enterOuterAlt(_localctx, 1);
			{
			}
