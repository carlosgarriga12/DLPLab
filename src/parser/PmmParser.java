...
public class PmmParser extends Parser {
	...
	public static final int
		...
		RULE_built_in_type = 7, RULE_type = 8, RULE_recordFields = 9, RULE_expression = 10, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"parameters", "parameter", "built_in_type", "type", "recordFields", "expression", 
	...
	public final RecordFieldsContext recordFields() throws RecognitionException {
		...
		try {
			...
			((RecordFieldsContext)_localctx).ID = match(ID);
			 _localctx.aux.add(((RecordFieldsContext)_localctx).ID);
			setState(195);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__7) {
