...
public class PmmParser extends Parser {
	...
	public static final int
		...
		RULE_built_in_type = 7, RULE_type = 8, RULE_recordFields = 9, RULE_recordField = 10, 
		RULE_expression = 11, RULE_statement = 12, RULE_body = 13, RULE_expressions = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "main_function", "definition", "varDefinition", "functionDefinition", 
			"parameters", "parameter", "built_in_type", "type", "recordFields", "recordField", 
			"expression", "statement", "body", "expressions"
		};
	}
		...
		try {
			...
			case T__14:
				...
				((TypeContext)_localctx).ast =  new RecordType(
				                                                            ((TypeContext)_localctx).START.getLine(),
				                                                            ((TypeContext)_localctx).START.getCharPositionInLine() + 1,
				                                                            ((TypeContext)_localctx).recordFields.ast
				                                                        );
				}
				break;
			default:
	...
	public final RecordFieldsContext recordFields() throws RecognitionException {
		...
		try {
			...
			do {
				...
				{
				setState(190);
				((RecordFieldsContext)_localctx).recordField = recordField();
				 _localctx.ast.add(((RecordFieldsContext)_localctx).recordField.ast); 
				}
				}
				setState(195); 
				_errHandler.sync(this);
	...
	public final RecordFieldContext recordField() throws RecognitionException {
		...
		try {
			...
			setState(200);
			match(T__8);
			((RecordFieldContext)_localctx).ast =  new RecordField(
			                                        ((RecordFieldContext)_localctx).ID.getLine(),
			                                        ((RecordFieldContext)_localctx).ID.getCharPositionInLine() + 1,
			                                        ((RecordFieldContext)_localctx).type.ast,
			                                        (((RecordFieldContext)_localctx).ID!=null?((RecordFieldContext)_localctx).ID.getText():null)
			                                   );
			}
		}
		catch (RecognitionException re) {
		...
		try {
			...
			case 8:
				...
				((ExpressionContext)_localctx).ast =  new Cast(
				            ...
				            ((ExpressionContext)_localctx).built_in_type.ast,
		...
		try {
			...
			case 3:
				...
				((StatementContext)_localctx).ast =  new IfElse(
				                                                                                    ...
				                                                                                    ((StatementContext)_localctx).elseStmts.ast
				                                                                                  );
				}
				break;
			case 4:
